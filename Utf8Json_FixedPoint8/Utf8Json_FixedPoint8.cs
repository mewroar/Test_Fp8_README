...
public static class WriterExtensions
{
    ...
    public static void WriteFixedPoint8(ref this JsonWriter writer, FixedPoint8 value)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                L12:
                    writer.WriteRawUnsafe((byte)('0' + (div = (num3 * 8389) >> 23)));
                    num3 -= div * 1000;
                L11:
                    writer.WriteRawUnsafe((byte)('0' + (div = (num3 * 5243) >> 19)));
                    num3 -= div * 100;
                L10:
                    writer.WriteRawUnsafe((byte)('0' + (div = (num3 * 6554) >> 16)));
                    num3 -= div * 10;
                L9:
        ...
        L8:
            writer.WriteRawUnsafe((byte)('0' + (div = (num2 * 8389) >> 23)));
            num2 -= div * 1000;
        L7:
            writer.WriteRawUnsafe((byte)('0' + (div = (num2 * 5243) >> 19)));
            num2 -= div * 100;
        L6:
            writer.WriteRawUnsafe((byte)('0' + (div = (num2 * 6554) >> 16)));
            num2 -= div * 10;
        L5:
    ...
    L4:
        writer.WriteRawUnsafe((byte)('0' + (div = (num1 * 8389) >> 23)));
        num1 -= div * 1000;
    L3:
        writer.WriteRawUnsafe((byte)('0' + (div = (num1 * 5243) >> 19)));
        num1 -= div * 100;
    L2:
        writer.WriteRawUnsafe((byte)('0' + (div = (num1 * 6554) >> 16)));
        num1 -= div * 10;
    L1:
